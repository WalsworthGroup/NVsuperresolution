class Madlib
{
    ...
    [DllImport("Madlib.dll", CallingConvention = CallingConvention.Cdecl)]
    public static extern int MCL_SequenceLoad(
        int axis,
        double[] sequence, 
        int seqSize,
        int handle
    ...
    [DllImport("Madlib.dll", CallingConvention = CallingConvention.Cdecl)]
    public static extern int MCL_SequenceClear(
        int handle
        );

    [DllImport("Madlib.dll", CallingConvention = CallingConvention.Cdecl)]
    public static extern int MCL_SequenceStart(
        int handle
        );

    [DllImport("Madlib.dll", CallingConvention = CallingConvention.Cdecl)]
    public static extern int MCL_SequenceStop(
        int handle
        );

    [DllImport("Madlib.dll", CallingConvention = CallingConvention.Cdecl)]
    public static extern int MCL_SequenceGetMax(
        ref int max,
        int handle
        );
