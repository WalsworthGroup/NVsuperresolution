...
dq.DownTime = 0.001; % 55 ms settling time
...
status = daq.ni.NIDAQmx.DAQmxCfgSampClkTiming(taskhandlein,dq.CtrInTrigTermName,double(1/dq.DwellTime*2),obj.DAQmx_Val_Rising,obj.DAQmx_Val_ContSamps,uint64(dq.npulses*10));
